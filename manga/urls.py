...
urlpatterns = [
    ...
    path("barcha/", views.manga_browse, name="browse"), # Barcha taytlar (filtr + paginate)
    ...
    path('chapter/<int:chapter_id>/rahmat/',views.thank_chapter, name='thank_chapter'),
    path('<slug:manga_slug>/add/', views.add_to_reading_list, name='add_to_reading_list'),
    path('<slug:manga_slug>/jild/<int:volume>/bob/<int:chapter_number>/purchase/', purchase_chapter, name="purchase_chapter"),
